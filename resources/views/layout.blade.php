        ...
        <header class="navbar navbar-fixed-top navbar-shadow">
            ...
            <ul class="nav navbar-nav navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-persist w350 animated animated-shorter fadeIn" role="menu">
                            <div class="panel mbn">
                                <div class="panel-menu">
                                    <span class="panel-icon"><i class="fa fa-film"></i></span>
                                    <span class="panel-title fw600">Vous avez {{count(session("id_movies"))}} film</span>


                                        <a  class="btn btn-default light btn-xs pull-right" href="{{ route("movies_vider")}} ">
                                        ...
                                        @foreach(session('id_movies', []) as $key=> $movie)
                                            <li class="timeline-item">
                                                ...
                                                <div class="timeline-desc">
                                                    <span class="panel-icon">
                                                    <b>{{ $movie }}</b> Added to his store:</span>
                ...
                <li class="dropdown menu-merge">
                    <div class="navbar-btn btn-group">
                        <button data-toggle="dropdown" class="btn btn-sm dropdown-toggle">
                            <span class="fa fa-user fs14 va-m"></span>
        ...
        <aside id="sidebar_left" class="nano nano-light affix">
            ...
            <div class="sidebar-left-content nano-content">
                    ...
                    <div class="sidebar-widget author-widget">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media-author">Zohra AMAR</div>
                            </div>
                        </div>
                    </div>
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a class="accordion-toggle" href="{{ route("movies_lister")}}">
                            <span class="glyphicon glyphicon-film"></span>
                            <span class="sidebar-title">Gestion des films
                               </span>
                            <span class="caret"></span>
                        </a>
                    ...
                    <li>
                        ...
                        <a class="accordion-toggle" href="{{route("actors_lister")}}">
